...
[![running binarysearch](https://img.shields.io/static/v1?&label=Lihat%20Hasil&message=%3e&color)](../../run.php?algoritma=jumpsearch)

untuk kode lengkapnya dapat dilihat pada link dibawah ini :

[![code binarysearch](https://img.shields.io/static/v1?&label=Contoh%20Kode&message=%3e&color)](./JumpSearch.php)
