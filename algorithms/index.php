...
<head>
    ...
    <title>Bellshade PHP - Algorithm</title>
                    ...
                    <div class="card-header p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="mb-0">PHP - Algorithm</h4>
                                    <span class="text-muted fst-italic">Daftar kategori algoritma bisa kamu akses dari disini</span>
                                </div>
                            </div>
                            <nav>
