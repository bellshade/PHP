...
<head>
    ...
    <title><?= $currentDirArray[count($currentDirArray) - 1] ?> - Bellshade PHP Algorithm</title>
                    ...
                    <div class="card-header p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="mb-0">PHP - Algorithms</h4>
                                    <span class="text-muted fst-italic">Demo algoritma bisa kamu akses dari disini</span>
                                </div>
                            </div>
                            <nav>
                                <ul class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="../../index.php">root</a></li>
                                    <li class="breadcrumb-item"><a href="../index.php">algorithms</a></li>
