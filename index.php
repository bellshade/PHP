...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_url ?>/basics/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= $base_url ?>/basics/assets/css/all.min.css">
    <link rel="stylesheet" href="<?= $base_url ?>/basics/assets/css/markdown-style.css">
    <link rel="icon" href="<?= $base_url ?>/basics/assets/images/icon.png">
        ...
        <div class="row mb-4 justify-content-center">
            <div class="col-auto text-center">
                <div class="mt-4" style="height: 64px; mix-blend-mode: darken">
                    <img class="h-100" src="<?= $base_url ?>/basics/assets/images/bellshade-inline.png" alt="Bellshade PHP Logo">
                </div>
            </div>
        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="me-4" style="width: 64px; height: 64px;">
                                    <img src="<?= $base_url ?>/basics/assets/images/phplogo.png" class="img-fluid">
                                </div>
                                <div>
