...
echo '<code style="color:blue;">$kota1 = ';
echo 'array(\'Padang\', \'Batu Sangkar\', \'Paya Kumbuh\', \'Pariaman\', \'Solok\');';
echo '</code><br>';
echo '<br>Hasil dari $kota1: <br>';
print_r($kota1);

echo '<br>Membuat Array dengan perintah :<br>';
echo '<code style="color:blue;">$kota2 = ';
echo '[\'Padang\', \'Batu Sangkar\', \'Paya Kumbuh\', \'Pariaman\', \'Solok\'];';
echo '</code><br>';
