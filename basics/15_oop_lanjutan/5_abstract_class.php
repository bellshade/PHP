...
\$frontendDeveloper = new FrontendDeveloper('John');
...
\$backendDeveloper = new BackendDeveloper('Alice');
...
echo "<br><br><h3>Hasil Dari Instansiasi Objek FrontendDeveloper</h3>";
